...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <img src="../../assets/dist/img/uca1.png" width="120px" height="120px" style="display: block; margin-left: auto; margin-right: auto; margin-top: 30px; margin-bottom: -20px;">

            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan Universitas Cendekia Abditama</h2>
            <p class="text-center">Alamat : Yayasan Islamic Vilage, Jln. Kelapa Dua, kec. Karawaci, Kab. Tangerang - Banten</p>
